(function ($) {
    $.fn.floatingWhatsApp = function (options) {
        ...
        if (settings.showPopup) {
            ...
            var $image = $('<img>', {
                src: '../img/dp.jpg', // Replace with your image source
                alt: 'Header Image',
                class: 'header-dp'
            });

            var $closeBtn = $('<button>', {// You can set the button text here
                class: 'close-button' // Add your desired class name for the close button
            });
            
            // Append the elements to the header with flex styling
            $header.css({
                display: 'flex',
                ...
                $image,
                $('<p>').text(settings.headerTitle), // Title
                 // Image
